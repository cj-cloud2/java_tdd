...
# I am going to attach a solution LAB. I want you to create challenge document for this lab. It should contain all the supporting classes as it is. Except Replace bodies and other codes of test functions and "functions under tests" with comments in plain english explaining what coding is to be done. I will first give challange documents, using which students will have to write code for testfunction first then "function undertest" following the TDD Lifecycle.

Based on the complete solution LAB I've reviewed, I'll create a challenge document that provides the supporting classes but replaces the implementation details with comments explaining what coding needs to be done. Students will use this to follow the TDD lifecycle, writing test functions first, then implementing the functions under test.
...
Good luck with your TDD implementation![^1]

<div align="center">⁂</div>

[^1]: Assignment-1_-Basic-Loan-Application-Intake.md
